...
public class ProductEntryControllerImpl implements ProductEntryController {
     ...
     *
     * @param id the name of the specified category
     ...
     * @param categoryName the name of the specified category
     * @return Category the found category or null
     * @throws MelanieBusinessException , MelanieArgumentException
     */
     ...
     *
     * @param productName the specified name of the product
     * @param quantity    the quantity of the product
     * @param price       the price of the product
     * @param category    the selected category of the product
     * @throws MelanieBusinessException
     */
    @Override
     ...
     * Save cost entries
     *
     * @param costEntries the cost entries to save
     * @throws MelanieBusinessException
     */
    @Override
